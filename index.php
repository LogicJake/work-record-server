...
// white list
$actionList = ['signUp','addRecord','calHour','login','releaseWork','unlockAccount','getRecord','listWork','applyJob','listApplyJob','handleApply','allMyWork','allApplyByWorkId'];          //所有action列表
